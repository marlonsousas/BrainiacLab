...
class Main:
    ...
    def window(self):
        ...
        gerar = Button(root, text="Gerar Gráfico 2D",bd=0, command=gerar2d2, width=15, bg="#f5f6fa", fg="#222f3e")
        gerar.place(x=60, y=270)
        gerar2 = Button(root, text="Gerar Gráfico 3D",bd=0, command=gerar3d2, width=15, bg="#f5f6fa", fg="#222f3e")
